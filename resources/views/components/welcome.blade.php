...
{{--            <select id="year" class="block w-full px-3 py-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-gray-600  focus:border-gray-600 sm:text-[13px]">--}}
...
{{--                </div>--}}
{{--                <div class="flex-1 flex flex-col items-start">--}}
{{--                    <h3 class="text-md font-semibold">16,452</h3>--}}
...
{{--            <!-- Card 4 -->--}}
{{--            <div @click="window.location.href='{{ route('transaction-walkin') }}'" class="relative cursor-pointer bg-white shadow rounded-lg flex items-center">--}}
{{--                <div class="flex-shrink-0 mr-4">--}}
...
{{--            <h4 class="text-[13px] mb-2 font-semibold text-center">Annual Report of Relocation LotList Applicants</h4>--}}
{{--            <div>--}}

...
@role('Housing System Tagger')
    <div class="flex-1 flex flex-col ml-[17%] mt-[-50%] md:mt-[-48%] sm:mt-[-80%] xs:mt-[-100%]">
        <!-- Header for large screens -->
        <header class="fixed top-0 left-0 bg-[#ffffff] p-4 hidden md:flex w-full justify-between items-center z-10">
            <!-- Navigation Links -->
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <div class="flex items-center space-x-2">
                    <img src="{{ asset('/storage/images/tagum_city_logo.png') }}" width="45px;" height="45px;" alt="Housing Logo">
                    <img src="{{ asset('/storage/images/housing_logo.png') }}" width="45px;" height="45px;" alt="Housing Logo">
                    <h3 class="text-[#328d56] font-semibold">City Housing and Land Management System</h3>
                </div>
            </div>

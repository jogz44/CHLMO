    ...
    <div class="p-10 h-screen ml-[17%] mt-[60px]">
        <div class="grid grid-cols-2 gap-10 mb-6">
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <a href="{{ route('admin.roles.create') }}" class="block rounded-md bg-custom-red px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-custom-green focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer">Add role</a>
            </div>
        </div>
                        ...
                        <td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                            <div class="flex justify-end">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.roles.edit', $role->id) }}" class="px-4 py-2 bg-custom-yellow text-white rounded-md">Edit</a>

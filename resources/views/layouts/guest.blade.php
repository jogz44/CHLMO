...
<head>
    ...
    <title>{{ config('app.name', 'CHLMS') }}</title>
    <link rel="icon" type="image/png" href="{{ asset('storage/images/tagum_city_logo.png') }}">
...
<body class="bg-gray-100 min-h-screen flex justify-center items-center lg:px-4 px-6 sticky lg:static" style="font-family:'Poppins', sans-serif;">
    <!-- Background Images -->

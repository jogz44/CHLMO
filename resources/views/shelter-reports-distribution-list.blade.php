                    ...
                    <table class="min-w-full bg-white border border-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="py-2 px-2 border-b text-center font-medium whitespace-nowrap">DATE OF IRS</th>
                                ...
                                <th class="py-2 px-2 border-b text-center font-medium whitespace-nowrap">AMAKAN SHEET</th>
                                <th class="py-2 px-2 border-b text-center font-medium whitespace-nowrap">COCO LUMBER 4X4X10</th>
                                <th class="py-2 px-2 border-b text-center font-medium whitespace-nowrap">NAILS - CWN 2 1/2</th>
                                <th class="py-2 px-2 border-b text-center font-medium whitespace-nowrap">TOILET BOWL PCS.</th>
                            </tr>
                        </thead>
                        <tbody x-data>
                            <tr>
                                <td class="py-4 px-2 text-center border-b">1</td>
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">2/22/2024</td>
                                <td class="py-4 px-2 text-center border-b">JP DELO SANTOS</td>
                                <td class="py-4 px-2 text-center border-b">9878854453</td>
                                <td class="py-4 px-2 text-center border-b">12</td>
                                <td class="py-4 px-2 text-center border-b">4</td>
                                <td class="py-4 px-2 text-center border-b">3</td>
                                <td class="py-4 px-2 text-center border-b"></td>
                            </tr>
                            <tr>
                            <td class="py-4 px-2 text-center border-b">2</td>
                            <td class="py-4 px-2 text-center border-b whitespace-nowrap">2/22/2024</td>
                                <td class="py-4 px-2 text-center border-b">KEN LONGAKIT</td>
                                <td class="py-4 px-2 text-center border-b">9878854453</td>
                                <td class="py-4 px-2 text-center border-b"></td>
                                <td class="py-4 px-2 text-center border-b">6</td>
                                <td class="py-4 px-2 text-center border-b">2</td>
                                <td class="py-4 px-2 text-center border-b">1</td>
                            </tr>
                            <tr>
                            <td class="py-4 px-2 text-center border-b">3</td>
                            <td class="py-4 px-2 text-center border-b whitespace-nowrap">2/22/2024</td>
                                <td class="py-4 px-2 text-center border-b">NADEL BANGCOLA</td>
                                <td class="py-4 px-2 text-center border-b">97421234</td>
                            ...
                            <td class="py-4 px-2 text-center border-b">4</td>
                            <td class="py-4 px-2 text-center border-b whitespace-nowrap">2/22/2024</td>
                                <td class="py-4 px-2 text-center border-b">ROLDAN NAVARRO</td>
                                <td class="py-4 px-2 text-center border-b">9231145678</td>
                                <td class="py-4 px-2 text-center border-b">12</td>
                                <td class="py-4 px-2 text-center border-b">4</td>
                                <td class="py-4 px-2 text-center border-b"></td>
                                <td class="py-4 px-2 text-center border-b"></td>
                            ...
                            <td class="py-4 px-2 text-center border-b">5</td>
                            <td class="py-4 px-2 text-center border-b whitespace-nowrap">2/22/2024</td>
                                <td class="py-4 px-2 text-center border-b">ANGEL PISON</td>
                                <td class="py-4 px-2 text-center border-b">9112345432</td>
                                <td class="py-4 px-2 text-center border-b">5</td>
                                <td class="py-4 px-2 text-center border-b">2</td>
                                <td class="py-4 px-2 text-center border-b"></td>
                                <td class="py-4 px-2 text-center border-b">1</td>

...
$perPageOptions = isset($this) && property_exists($this, 'perPageOptions')
    ? $this->perPageOptions
    : [5, 10, 25, 50, 100];
...
? <<<JS
    ...
    <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div class="flex items-center gap-2 text-gray-600 justify-start">
                <label for="per_page" class="text-[12px] font-medium">Rows per page</label>
                <select id="per_page" wire:model.live="perPage" class="border text-[12px] border-gray-300 rounded px-2 py-1 bg-white">

    ...
    <div x-data="{ openFilters: false }" class="p-10 h-screen ml-[17%] mt-[60px]">
        <div class="flex bg-gray-100 text-[12px]">
            ...
            <div x-data="pagination()" class="flex-1 h-screen p-6 overflow-auto">
                ...
                <div x-data="{openModalGrant: false, openModalTag: false, openPreviewModal: false, selectedFile: null, fileName: ''}"
                        ...
                        <tbody x-data>
                            <tr>
                                ...
                                <td class="py-4 px-2 text-center border-b space-x-2">
                                    <button
                                        @click="window.location.href = '{{ route('shelter-assistance-applicant-details') }}'"
                                    ...
                                    <button @click="openModalGrant = true"
                                        class="bg-custom-green text-white px-8 py-1.5 rounded-full">Grant
                                    </button>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div x-data="{
                        ...
                        <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative">
                            ...
                            <form>
                                ...
                                <div class="mb-4">
                                    <label class="block text-[12px] font-medium mb-2 text-black">MATERIALS
                                        PROVIDED</label>
                                    <div class="grid grid-cols-2 gap-2">
                                        ...
                                        <div>
                                            <input type="text" placeholder="10 pcs"
                                                class="w-full px-3 py-2 border border-gray-600 rounded-lg text-gray-800 text-[12px] focus:outline-none focus:ring-1 focus:ring-gray-600">
                                        </div>
                                        <div>
                                            <select class="w-full px-3 py-2 border border-gray-600 rounded-lg text-gray-800 text-[12px] focus:outline-none focus:ring-1 focus:ring-gray-600">
                                                <option>Metal Sheet</option>
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mt-3 mb-2">
                                        <input type="text" x-model="materials[0].material"
                                            class="w-full px-3 py-2 border border-gray-600 rounded-lg text-gray-800 text-[12px] focus:outline-none focus:ring-1 focus:ring-gray-600"
                                            placeholder="Material">
                                        <input type="text" x-model="materials[0].quantity"
                                            class="w-full px-3 py-2 border border-gray-600 rounded-lg text-gray-800 text-[12px] focus:outline-none focus:ring-1 focus:ring-gray-600"
                                    ...
                                    <template x-for="(item, index) in materials.slice(1)" :key="index">
                                        <div class="grid grid-cols-2 gap-4 mb-2">
                                            <input type="text" x-model="item.material"
                                                class="w-full px-3 py-2 border border-gray-600 rounded-lg text-gray-800 text-[12px] focus:outline-none focus:ring-1 focus:ring-gray-600"
                                                placeholder="Material">

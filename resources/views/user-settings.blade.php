    ...
    <div x-data="{ openFilters: false }" class="p-10 h-screen ml-[17%] mt-[60px]">
        <div class="flex bg-gray-100 text-[12px]">
            ...
            <div class="bg-white rounded shadow mb-4 flex items-center justify-between z-50 relative p-3">
                    ...
                    <div x-data="{ openModalUser: false}"  class="relative z-0">
                    <button @click="openModalUser = true" class="bg-custom-yellow text-white px-4 py-2 rounded">Add
                                User
                            </button>
                            <button class="bg-custom-green text-white px-4 py-2 rounded">Export</button>

                            <div x-show="openModalUser"
                                ...
                                <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative">
                                    <div class="flex justify-between items-center mb-4">
                                        ...
                                        <button @click="openModalUser = false" class="text-gray-400 hover:text-gray-200">
                                            &times;
                                        </button>
                                    </div>
                                    ...
                                    <div class="mb-2 py-3">
                                        ...
                                        <select class="w-full px-3 py-3 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800  focus:outline-none focus:ring-1 focus:ring-gray-600 text-[12px]"
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                        <button type="submit"
                                                class="w-full py-2 bg-custom-yellow hover:bg-custom-yellow text-white font-semibold rounded-lg flex items-center justify-center space-x-2">
                ...
                <div class="bg-white p-6 rounded shadow">
                    ...
                    <div x-data="{openModalEditUser: false, openModalDisable: false}" class="overflow-x-auto">
                        <table class="min-w-full bg-white border border-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="py-4 px-2 text-center border-b space-x-2">
                                    ...
                                    <button @click="openModalDisable = true"
                                            class="bg-custom-dark-green text-white px-4 py-2 rounded">Disable
                                    </button>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <div x-show="openModalEditUser"
                             class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" x-cloak
                             style="font-family: 'Poppins', sans-serif;">
                            <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative">
                                <div class="flex justify-between items-center mb-4">
                                    <h3 class="text-[16px] font-semibold text-black">EDIT USER</h3>
                                    <button @click="openModalEditUser = false" class="text-gray-400 hover:text-gray-200">
                                        &times;
                                    </button>
                                </div>
                                <div class="grid grid-cols-2 gap-3 mb-2">
                        ...
                        <div x-show="openModalDisable"
                            ...
                            <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative">
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4">
                                    <button type="submit"
                                            class="w-full py-2 bg-custom-red hover:bg-custom-red text-white font-semibold rounded-lg flex items-center justify-center space-x-2">
                                        <span class="text-[12px]">CONFIRM</span>
                                    </button>
                                    <button @click="openModalDisable = false" type="submit"
                                            class="w-full py-2 bg-gray-600 hover:bg-gray-500 text-white font-semibold rounded-lg flex items-center justify-center space-x-2">
                                        <span class="text-[12px]">CANCEL</span>
                                    </button>
                                </div>

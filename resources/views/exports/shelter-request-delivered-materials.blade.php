<table>
    ...
    <tr>
        <td colspan="5" style="text-align: center; margin-top: 40px; font-size: 11px; font-weight: bold;">
    ...
    <tr>
        <td colspan="5" style="text-align: center; font-size: 9px; font-weight: regular;">

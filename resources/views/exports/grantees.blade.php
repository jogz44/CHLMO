<table>
    ...
    <!-- Spacing -->
    <tr>
        <td colspan="13" height="81.6"></td>
    </tr>
    <tr>
        <td colspan="13" style="text-align: center; margin-top: 40px; font-size: 16px; font-weight: bold;">
    ...
    <tr>
        <td colspan="13" style="text-align: center; font-size: 20px; font-weight: bold;">

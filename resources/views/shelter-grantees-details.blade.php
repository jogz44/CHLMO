            ...
            <div x-data="{ isEditable: false }" class="flex-1 p-6 overflow-auto">
                ...
                <form>
                    <div class="bg-white p-6 rounded shadow mb-6">
                        ...
                        <div class="flex flex-wrap -mx-2">
                            ...
                            <div class="w-full md:w-1/3 px-2 mb-4">
                                ...
                                <input type="date" id="requestDate" name="requestDate" :disabled="!isEditable"
                                    class="uppercase w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded shadow mb-6">
                        <div class="flex flex-wrap -mx-2">
                            <div class="w-full md:w-1/3 px-2 mb-4">
                                ...
                                <input type="number" id="age" name="age" :disabled="!isEditable"
                                    class="uppercase w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                            </div>
                            <div class="w-full md:w-1/3 px-2 mb-4">
                    ...
                    <div class="flex flex-col p-3 rounded mt-5 mb-1">
                        <h2 class="text-[13px] ml-2 items-center font-bold text-gray-700">DELIVERY DETAILS</h2>
                    </div>

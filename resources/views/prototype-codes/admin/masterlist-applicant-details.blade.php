    ...
    <div x-data="{ isEditable: false }" class="flex-1 ml-[17%] mt-[50px] p-6 overflow-auto">
        <div class="bg-white rounded shadow mb-4 flex items-center justify-between relative p-3">
            <div class="flex items-center">
                <a href="{{ route('masterlist-applicants') }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-custom-yellow mr-2">
            ...
            <form>
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="purok" name="purok" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <input type="text" id="landmark" name="landmark" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-1/4 px-2 mb-4">
                        ...
                        <select id="tribe" name="tribe" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                    ...
                    <div class="w-full md:w-1/4 px-2 mb-4">
                        ...
                        <select id="gender" name="gender" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
            ...
            <form>
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="livingSituation" name="livingSituation" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="caseSpecific" name="caseSpecific" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="govAssistance" name="govAssistance" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="livingStatus" name="livingStatus" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                ...
                <div class="flex flex-wrap -mx-2">
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="roof" name="roof" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <select id="wall" name="wall" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">
                ...
                <div class="flex flex-wrap -mx-2">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        <label for="livingStatus" class="block text-[13px] font-medium mt-6 text-gray-700 mb-1">APPLICANT TYPE</label>
                        <select id="livingStatus" name="livingStatus" :disabled="!isEditable" class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">

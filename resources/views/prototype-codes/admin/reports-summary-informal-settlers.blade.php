...
{{--                </div>--}}
{{--                <img src="{{ asset('storage/halmsAssets/design.png') }}" alt="Design"--}}
...
{{--                        <option value="/prototype-codes/admin/reports-summary-informal-settlers" selected>Summary of--}}
{{--                            Identified Informal Settlers--}}
{{--                        </option>--}}
{{--                        <option value="/prototype-codes/admin/reports-summary-relocation-applicants">Relocation--}}
{{--                            Applicant Summary--}}
{{--                        </option>--}}
{{--                    </select>--}}
{{--                </div>--}}
...
{{--                <h2 class="text-[14px] font-semibold items-center text-gray-700">Summary of Identified Informal--}}
{{--                    Settlers</h2>--}}
{{--            </div>--}}

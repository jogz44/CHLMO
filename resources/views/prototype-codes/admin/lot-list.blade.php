    ...
    <div x-data="pagination()" class="flex-1 h-screen p-6 overflow-auto">
        ...
        <div x-data="fileUpload()" class="bg-white p-6 rounded shadow">
            ...
            <div x-data="{openModalEditLot: false}" class="overflow-x-auto">
                ...
                <!-- Modal Background -->
                <div x-show="openModalTransfer" class="fixed inset-0 flex z-50 items-center justify-center w-full bg-black bg-opacity-50 shadow-lg" x-cloak>
                    <!-- Modal -->
                    <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative max-h-[90vh] overflow-y-auto scrollbar-hide">
                        ...
                        <div class="flex justify-between items-center mb-2">
                            ...
                            <button @click="openModalTransfer = false" class="text-gray-400 hover:text-gray-200">&times;</button>
                        </div>
                        ...
                        <form @submit.prevent>
                            <!-- Date Applied Field -->
                            <div class="mb-1">
                                <label class="block text-[12px] font-medium mb-2 text-black" for="date-applied">DATE UPDATED</label>
                                <input type="date" id="date-updated" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Date Applied">
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2 mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="first-name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="First Name">
                                </div>

                                <!-- Middle Name Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="middle-name">MIDDLE NAME</label>
                                    <input type="text" id="middle-name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Middle Name">
                                </div>

                                <!-- Last Name Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="last-name">LAST NAME</label>
                                    <input type="text" id="last-name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Last Name">
                                </div>

                                <!-- Suffix Name Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="suffix-name">SUFFIX NAME</label>
                                    <input type="text" id="suffix-name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Suffix Name">
                                </div>
                            </div>
                            ...
                            <div class="mb-1">
                                <label class="block text-[12px] font-medium mb-2 text-black" for="barangay">BARANGAY</label>
                                <input type="text" id="barangay" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Barangay">
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-2 mb-1">
                                <!-- Purok Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-1 text-black" for="purok">PUROK</label>
                                    <input type="text" id="purok" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Purok">
                                </div>

                                <!-- Age Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-1 text-black" for="age">AGE</label>
                                    <input type="text" id="age" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Age">
                                </div>

                                <!-- Contact Number Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="contact-number">CONTACT NUMBER</label>
                                    <input type="text" id="contact-number" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Contact Number">
                                </div>

                                <!-- Gender Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="gender">GENDER</label>
                                    <input type="text" id="gender" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Gender">
                                </div>

                                <!-- Religion Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="religion">RELIGION</label>
                                    <input type="text" id="religion" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Religion">
                                </div>

                                <!-- Status Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="status">STATUS</label>
                                    <input type="text" id="status" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Status">
                                </div>

                                <!-- Occupation Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="occupation">OCCUPATION</label>
                                    <input type="text" id="occupation" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Occupation">
                                </div>

                                <!-- Monthly Income Field -->
                                <div>
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="monthly-income">MONTHLY INCOME</label>
                                    <input type="text" id="monthly-income" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]" placeholder="Monthly Income">
                                </div>
                            </div>

                            <h2 class="block text-[12px] font-medium mb-2 text-black">UPLOAD REQUIREMENT DOCUMENTS</h2>
                            ...
                            <div class="border-2 border-dashed border-green-500 rounded-lg p-4 flex flex-col items-center space-y-1 mb-2">
                                ...
                                <input type="file" x-ref="fileInput" @change="addFiles($refs.fileInput.files)" multiple class="hidden" />
                            </div>

                            <!-- Show selected file and progress bar when a file is selected -->
                            <template x-for="(fileWrapper, index) in files" :key="index">
                                <div @click="openPreviewModal = true; selectedFile = fileWrapper" class="bg-white p-2 shadow border-2 border-green-500 rounded-lg">
                                    <div class="flex items-center justify-between mb-2">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-xs font-medium text-gray-700" x-text="fileWrapper.displayName, selectedFile.displayName"></span>
                                        </div>
                                        <!-- Status -->
                    ...
                    <div x-show="openPreviewModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 shadow-lg" x-cloak>
                        <div class="bg-white w-[600px] rounded-lg shadow-lg p-6 relative">
                            ...
                            <div class="flex justify-between items-center mb-4">
                                <input type="text" x-model="selectedFile.displayName" class="text-[13px] w-[60%] font-regular text-black border-none focus:outline-none focus:ring-0">
                            ...
                            <div class="flex justify-center mb-4">
                                <img :src="selectedFile ? URL.createObjectURL(selectedFile.file) : '/path/to/default/image.jpg'" alt="Preview Image" class="w-full h-auto max-h-[60vh] object-contain">
                            </div>
                            <!-- Modal Buttons -->
                            <div class="flex justify-between mt-4">
                                <button class="px-4 py-2 bg-green-600 text-white rounded-lg" @click="openPreviewModal = false">CONFIRM</button>
                                <button class="px-4 py-2 bg-red-600 text-white rounded-lg" @click="removeFile(selectedFile); openPreviewModal = false">REMOVE</button>
                            </div>
                        </div>
                    </div>
                </div>

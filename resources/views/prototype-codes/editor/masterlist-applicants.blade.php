                    ...
                    <div x-show="openModal" class="fixed inset-0 flex z-50 items-center justify-center w-full bg-black bg-opacity-50 shadow-lg" x-cloak>
                        <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative">
                            ...
                            <form>
                                ...
                                <div class="mb-4">
                                    <label class="block text-[12px] font-medium mb-2 text-black" for="barangay">TYPE OF APPLICANT</label>
                                    <select class="block text-[12px] w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800  focus:outline-none focus:ring-1 focus:ring-gray-600" style="padding: 2px 4px;">
                             ...
                             <div class="mb-4">
                               ...
                               <div class="mb-4">
                                    ...
                                    <input type="text" id="initially-interviewed-by" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800  focus:ring-1 focus:ring-gray-600 text-[12px]" placeholder="Initially Interviewed By">
                                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-4 px-2 text-center border-b space-x-2">
                                <button
                                    @click="window.location.href = '{{ route('editor-masterlist-applicant-details') }}'"

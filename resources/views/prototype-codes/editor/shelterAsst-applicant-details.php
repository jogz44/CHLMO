    ...
    <div x-data="{ isEditable: false }" class="flex-1 ml-[17%] mt-[50px] p-6 overflow-auto">
        <div class="bg-white rounded shadow mb-4 flex items-center justify-between relative p-3">
            <div class="flex items-center">
                <a href="{{ route('transaction-shelter-assistance') }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5 text-custom-yellow mr-2">

    ...
    <div class="flex bg-gray-100 text-[12px]">
        <div class="flex-1 overflow-auto">
            <form wire:submit.prevent="store">
                <div x-data="{ showConfirmationModal: false }" class="app-page-heading">
                    <div class="flex items-center">
                        <a href="{{ route('applicants') }}" class="z-10">
                    ...
                    <div class="flex space-x-2 z-10">
                        ...
                        <button type="button"
                            ...
                            class="bg-gradient-to-r from-custom-red to-green-700 hover:bg-gradient-to-red hover:from-custom-red-400 hover:to-custom-red-700 text-white text-xs font-semibold px-6 py-2 rounded z-30">
                            SUBMIT
                            <div wire:loading>
                    ...
                    <div x-show="showConfirmationModal"
                        x-cloak
                        class="fixed inset-0 bg-gray-600 bg-opacity-65 overflow-y-auto flex items-center justify-center z-50"
                ...
                <div class="flex flex-col lg:flex-row rounded mt-2">
                ...
                <div class="flex flex-col p-3 rounded">
                    <h2 class="text-[13px] items-center font-bold text-gray-700">PERSONAL INFORMATION</h2>
                    <p class="text-[12px] ml-2 items-center text-gray-700">Encode here the personal information of the
                        Applicant from the form.</p>
                </div>

                @if ($errors->any())
                <div class="mx-3 mb-4 rounded border border-red-200 bg-red-50 p-3 text-red-700">
                    <p class="text-[12px] font-semibold">Please fix the highlighted fields before saving.</p>
                        ...
                        <div class="flex flex-wrap -mx-2">
                            ...
                            <div class="w-full md:w-1/4 px-2 mb-4">
                                <label for="tribe" class="block text-[12px] font-semibold text-gray-700 mb-1">
                                    TRIBE/ETHNICITY <small>(Select N/A if none)</small> <span class="text-red-500">*</span>
                                </label>
                        ...
                        <div class="flex flex-wrap -mx-2">
                            <div class="w-full md:w-1/4 px-2 mb-4">
                                <label for="religion" class="block text-[12px] font-semibold text-gray-700 mb-1">
                                    RELIGION <small>(Select N/A if none)</small> <span class="text-red-500">*</span>
                                </label>
                    ...
                    <div class="mt-6">
                            <div class="flex justify-between">
                                <div class="mt-4 flex justify-start">
                                    <h2 class="text-[12px] font-semibold text-gray-700 mb-2">DEPENDENTS <span class="text-red-500">*</span></h2>
                                </div>
                            </div>

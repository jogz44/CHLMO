...
{{--            </div>--}}
            ...
            <div class="flex flex-col p-3 rounded mt-12">
                <h1 class="text-[30px] ml-2 items-center font-bold text-gray-700 underline">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-1/4 px-2 mb-4">
                            ...
                            <input type="text" id="first-name" name="first-name" wire:model="first_name"
                                   :disabled="!isEditable"
                                   class="w-full p-1 border text-[13px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow uppercase">
                        </div>
                        <div class="w-full md:w-1/4 px-2 mb-4">

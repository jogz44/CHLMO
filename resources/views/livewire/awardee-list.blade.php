                                        ...
                                        <div class="flex space-x-2">
                                            @if($awardee->is_blacklisted)
                                                @if($awardee->documents_submitted)
                                                    <!-- Transferred -->
                                                    <button class="px-4 py-2 bg-gray-500 text-white rounded-full cursor-not-allowed" disabled>
                                                        Transferred
                                                    </button>
                                                @else
                                                    <!-- Blacklisted -->
                                            ...
                                            @elseif($awardee->documents_submitted)
                                                ...
                                                <button class="px-4 py-2 bg-amber-500 text-white rounded-full cursor-default">
                                                    Submitted
                                                </button>
                                                <button wire:click="openConfirmModal({{ $awardee->id }})"
                                                        class="px-4 py-2 bg-gradient-to-r from-custom-red to-green-700 hover:bg-gradient-to-r hover:from-custom-green hover:to-custom-green text-white rounded-full">
                                                    Transfer
                                                </button>
                                            @else
                                                <!-- Initial Transfer Button -->
                                                <button wire:click="openTransferModal({{ $awardee->id }})"
                                                        class="px-4 py-2 bg-amber-500 text-white rounded-full">
                                                    Transfer
                                                    <div wire:loading>
                                                        <!-- Loading spinner -->
                                                        <svg aria-hidden="true" class="w-3 h-3 mx-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <!-- ... spinner path ... -->
                                                        </svg>
                                        ...
                                        @if(isset($spouse))
                                            <div class="p-4 border rounded hover:bg-gray-50 cursor-pointer transition duration-150"
                                                ...
                                                <div class="font-semibold">
                                                    {{ $spouse->spouse_last_name }}, {{ $spouse->spouse_first_name }} {{ $spouse->spouse_middle_name }}
                                                </div>
                                        ...
                                        <div class="flex flex-nowrap gap-4 min-w-full">
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="originalCopyOfNoticeOfAward">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="deathCert">
                                                ...
                                                <p class="uppercase font-bold text-gray-900 text-sm">
                                                 ...
                                                 <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    const pond = FilePond.create($refs.input, {
                                                     ...
                                                     <input x-ref="input" type="file" accept="image/*" wire:model="marriageCert">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="validId1">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="validId2">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="votersCert">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="birthCert">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="extraJudicialSettlement">
                                            ...
                                            <div class="flex-none w-80 bg-gray-50 p-2 rounded-lg shadow-sm">
                                                ...
                                                <div wire:ignore x-data="{ isUploading: false }" x-init="
                                                    ...
                                                    <input x-ref="input" type="file" accept="image/*" wire:model="certOfNoLandHolding">

            ...
            <form wire:submit.prevent="store"
                ...
                <div class="app-page-heading">
                    <div class="flex items-center">
                        ...
                        <h2 class="text-[13px] items-center text-gray-700">ADD NEW OCCUPANT</h2>
                    </div>
                    ...
                    <div x-data="{ saved: false }" class="flex space-x-2 z-10">
                        <button type="submit"
                            ...
                            <span wire:loading.remove class="hidden lg:flex">
                                {{ $isTransfer ? 'SUBMIT TRANSFER' : 'SUBMIT NEW OCCUPANT' }}
                            </span>
                            <span wire:loading.remove class="lg:hidden flex">
                                SUBMIT
                            </span>
                ...
                <div class="flex flex-col p-3 rounded bg-gray-200 mt-2">
                ...
                <div class="flex flex-col p-3 rounded mt-2">
                    ...
                    <div x-data="{ civilStatus: '' }">
                        ...
                        <div class="flex flex-wrap -mx-2">
                            ...
                            <div class="w-full md:w-1/4 px-2 mb-4">
                                ...
                                <!-- <div class="mb-1">
                                    <span class="text-xs text-gray-500">Tribe items: {{ isset($tribe) ? (is_countable($tribe) ? count($tribe) : 'not countable') : 'not set' }}</span>
                                </div> -->
                                ...
                                @error('tribe_id') <span class="text-red-600 error">{{ $message }}</span> @enderror
                            </div>
                            <!-- Sex (required) -->
                            <div class="w-full md:w-1/4 px-2 mb-4">
                        ...
                        <div class="flex flex-wrap -mx-2">
                            <div class="w-full md:w-1/4 px-2 mb-4">
                                ...
                                @error('religion_id') <span class="text-red-600 error">{{ $message }}</span> @enderror
                            </div>
                            <!-- Occupation -->
                            <div class="w-full md:w-1/4 px-2 mb-4">

        ...
        <div class="flex-1 overflow-auto">
            ...
            <div class="app-page-heading">
                ...
                <div class="flex justify-end z-20">
                    ...
                    @elseif ($awardee->is_blacklisted)
                    <button disabled aria-disabled="true"
                        class="bg-gradient-to-r from-custom-red to-green-700 text-white px-4 py-2 rounded-md text-sm flex items-center opacity-50 cursor-not-allowed">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                        <span wire:loading.remove>
            ...
            <div class="flex flex-col lg:flex-row rounded">
                <h2 class="text-[30px] ml-2 items-center font-bold text-gray-700 underline">
                ...
                <h1 class="text-[20px] ml-3 lg:text-[30px] items-center font-bold text-gray-700 justify-content">
                                    ...
                                    <div x-data="{ civilStatus: @entangle('editPrimaryInfo.civil_status_id') }" class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <select id="edit_tribe"
                                                    x-model="tribe"
                                                    wire:model="editPrimaryInfo.tribe_id"
                                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                                ...
                                                @error('editPrimaryInfo.tribe_id')
                                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <select id="edit_religion"
                                                    x-model="religion"
                                                    wire:model="editPrimaryInfo.religion_id"
                                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                                ...
                                                @error('editPrimaryInfo.religion_id')
                                                <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                                                @enderror
                                            </div>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button type="button"
                        ...
                        class="mt-3 mr-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom-red sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Cancel
                    </button>
                </div>
            </div>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button type="button"
                        ...
                        class="mt-3 mr-2 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-custom-red sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        Cancel
                    </button>
                </div>
            </div>

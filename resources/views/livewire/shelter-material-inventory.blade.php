                    ...
                    <div class="w-full lg:w-1/2 pr-4 grid grid-cols-1 mt-10 mb-10">
                        <div class="flex flex-wrap -mx-2 mb-1 items-center">
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                <label class=" whitespace-nowrap text-[12px] font-medium mb-2 text-black">PURCHASE ORDER NO.</label>
                            ...
                            <div class="w-full md:w-1/3 px-3">
                                <label class=" whitespace-nowrap block text-[12px] font-medium mb-2 text-black">PURCHASE REQUISITION NO.</label>

<div class="p-10 h-screen ml-[17%] mt-[60px]">
    ...
    <div class="grid grid-cols-3 gap-10 mb-8">
        ...
        <a href="{{ route('shelter-profiled-tagged-applicants') }}">
            <!-- Card 3 -->
            <div @click="window.location.href='{{ route('shelter-profiled-tagged-applicants') }}'" class="relative cursor-pointer bg-white shadow rounded-lg flex items-center">
                <div class="flex-shrink-0 mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" fill="currentColor" stroke="currentColor" viewBox="0 0 48 48" class="w-6 h-6 ml-5 text-custom-yellow" stroke-width="0.5">
        ...
        <a href="{{ route('shelter-grantees') }}">
            <div @click="window.location.href='{{ route('shelter-grantees') }}'" class="relative cursor-pointer bg-white shadow rounded-lg flex items-center">
                <div class="flex-shrink-0 mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" fill="currentColor" stroke="currentColor" viewBox="0 0 48 48" class="w-6 h-6 ml-5 text-custom-yellow" stroke-width="0.5">

            ...
            <div x-data="{
                ...
                <div class="@role('Housing System Tagger') bg-white rounded shadow mb-4 flex flex-col sm:flex-row items-center justify-between z-0 relative p-3 @else bg-white rounded shadow mb-4 flex items-center justify-between z-0 relative p-3 @endrole">
                    <div class="@role('Housing System Tagger') flex items-center mb-3 sm:mb-0 @else flex items-center @endrole">
                        <h2 class="@role('Housing System Tagger') text-[15px] font-bold items-center justify-center ml-2 mt-5 sm:ml-5 text-gray-700 @else text-[13px] ml-5 text-gray-700 @endrole">APPLICANTS</h2>
                    </div>
                ...
                <div class="@role('Housing System Tagger') bg-white p-4 lg:p-6 rounded shadow @else bg-white p-6 rounded shadow @endrole">
                    <div class="@role('Housing System Tagger') flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 @else flex justify-between items-center @endrole">
                        ...
                        <div class="@role('Housing System Tagger') flex flex-col sm:flex-row gap-2 w-full sm:w-auto @endrole">
                            <div class="justify-end hidden lg:flex md:flex">
                    ...
                    <div x-show="openFilters" class="flex-col lg:flex-row lg:gap-0 gap-2 @role('Housing System Tagger') flex flex-col sm:flex-row gap-2 mb-1 mt-5 @else flex space-x-2 mb-1 mt-5 @endrole">
                        <div class="flex lg:hidden md:hidden @role('Housing System Tagger') flex flex-col sm:flex-row gap-2 w-full sm:w-auto @endrole">
                            ...
                            <table class="@role('Housing System Tagger') min-w-full divide-y divide-gray-300 @else min-w-full bg-white border border-gray-200 @endrole">
                                <thead class="bg-gray-100">
                                    <tr>
                                        ...
                                        <th class="@role('Housing System Tagger') hidden sm:table-cell py-2 px-2 border-b text-center font-medium @else py-2 px-2 border-b text-center font-medium @endrole" wire:click="sortBy('transaction_type')">
                                            Transaction Type
                                            @if($sortField === 'transaction_type')
                                            <span>{{ $sortDirection === 'asc' ? '▲' : '▼' }}</span>
                                            @endif
                                        </th>
                                        <th class="py-2 px-2 border-b text-center font-medium cursor-pointer select-none" wire:click="sortBy('date_applied')">
                                            Date Applied

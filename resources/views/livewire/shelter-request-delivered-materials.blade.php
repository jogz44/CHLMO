                ...
                <div class="bg-white p-6 rounded shadow">
                    ...
                    <div x-show="openFilters" class="flex space-x-2 mb-1 mt-5">
                        ...
                        <select class="border text-[13px] border-gray-300 text-gray-600 rounded px-2 py-1 shadow-sm">
                            ...
                            <option value="barangay1">All</option>
                            <option value="purok1">22-10-0052</option>
                            <option value="purok2">23-11-0123</option>
                            <option value="purok3">23-11-0252</option>
                        </select>
                        <select class="border text-[13px] border-gray-300 text-gray-600 rounded px-2 py-1 shadow-sm">
                    ...
                    <table class="min-w-full bg-white border border-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="py-2 px-2 border-b text-center font-medium whitespace-nowrap">No. of Requests, Tagged and Validated</th>
                        ...
                        <tbody x-data>
                            <tr>
                                ...
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">Busaon</td>
                            ...
                            <td class="py-4 px-2 text-center border-b">2</td>
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">Apokon</td>
                                <td class="py-4 px-2 text-center border-b">250</td>
                                <td class="py-4 px-2 text-center border-b">124</td>
                                <td class="py-4 px-2 text-center border-b">100</td>
                            </tr>
                            <tr>
                            <td class="py-4 px-2 text-center border-b">3</td>
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">Bincungan</td>
                            ...
                            <td class="py-4 px-2 text-center border-b">4</td>
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">Mankilam</td>
                                <td class="py-4 px-2 text-center border-b">60</td>
                                <td class="py-4 px-2 text-center border-b">30</td>
                                <td class="py-4 px-2 text-center border-b">12</td>
                            </tr>
                            <tr>
                            <td class="py-4 px-2 text-center border-b">5</td>
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">Magugpo North</td>
                                <td class="py-4 px-2 text-center border-b">85</td>
                                <td class="py-4 px-2 text-center border-b">60</td>
                                <td class="py-4 px-2 text-center border-b">40</td>
                            </tr>
                            <tr>
                            <td class="py-4 px-2 text-center border-b">6</td>
                                <td class="py-4 px-2 text-center border-b whitespace-nowrap">Magugpo West</td>
                                <td class="py-4 px-2 text-center border-b">100</td>
                                <td class="py-4 px-2 text-center border-b">60</td>
                                <td class="py-4 px-2 text-center border-b">45</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

<div x-data="{ openFilters: false }" class="app-page">
    <div class="flex bg-gray-100 text-[12px]">
        ...
        <div class="app-table-scroll">
            ...
            <div class="bg-white p-6 rounded shadow">
                ...
                <div x-show="openFilters" class="flex-col lg:flex-row lg:gap-0 gap-2 mb-1 mt-5">
            ...
            <div x-data="{openModalRelocate: false, openModalDocumentsChecklist: false, openModalTag: false, openPreviewModal: false, selectedFile: null, fileName: ''}"
                ...
                {{-- @error('letterOfIntent')<div class="text-red-400 text-sm">{{ $message }}
            </div>@enderror--}}
            {{-- </div>--}}
            {{-- </div>--}}
            ...
            {{-- @error('votersID')<div class="text-red-400 text-sm">{{ $message }}
        </div>@enderror--}}
        {{-- </div>--}}
        {{-- </div>--}}
        ...
        {{-- @error('validID')<div class="text-red-400 text-sm">{{ $message }}
    </div>@enderror--}}
    {{-- </div>--}}
    {{-- </div>--}}
    ...
    {{-- @error('certOfNoLandHolding')<div class="text-red-400 text-sm">{{ $message }}
</div>@enderror--}}
{{-- </div>--}}
{{-- </div>--}}

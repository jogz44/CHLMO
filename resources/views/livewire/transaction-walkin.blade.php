...
{{--            </div>--}}
            ...
            <div class="bg-white rounded shadow mb-4 flex items-center justify-between z-50 relative p-3">
                ...
                <div class="relative z-0">
                    <button wire:click="$set('isModalOpen', true)" class="bg-custom-red text-white px-4 py-2 rounded">Add
                        Applicant
                    </button>
                        ...
                        <div class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                            <div class="bg-white text-white w-[400px] rounded-lg shadow-lg p-6 relative z-50">
                                ...
                                <form wire:submit.prevent="store">
                                    <!-- Date Applied Field -->
                                    <div class="mb-4">
                                        <label class="block text-[12px] font-medium mb-2 text-black" for="date_applied">Date Applied</label>
                                        <input type="date" id="date_applied" wire:model="date_applied" class="w-full bg-white border-gray-600 rounded-lg text-gray-800">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="transaction_type_id" wire:model="transaction_type_id" class="w-full bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px]">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model="first_name" id="first_name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px] uppercase" required placeholder="First Name">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model="middle_name" id="middle_name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px] uppercase" placeholder="Middle Name">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model="last_name" id="last_name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px] uppercase" required placeholder="Last Name">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" wire:model="suffix_name" id="suffix_name" class="w-full px-3 py-1 bg-white border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px] uppercase" placeholder="Suffix Name">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="barangay" wire:model.live="barangay_id" class="w-full select2-barangay bg-white-700 border border-gray-600 rounded-lg text-gray-800 uppercase" required>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select id="purok" wire:model.live="purok_id" class="w-full select2-purok bg-white-700 border border-gray-600 rounded-lg text-gray-800 uppercase" required>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" wire:model="contact_number" id="contact_number" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px] uppercase" placeholder="Contact Number">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="interviewer" wire:model="interviewer" class="w-full px-3 py-1 bg-white-700 border border-gray-600 rounded-lg placeholder-gray-400 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400 text-[12px] uppercase" readonly>
                                    </div>

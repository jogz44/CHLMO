                ...
                <div x-data="{ civilStatus: '' }" class="bg-white p-6 rounded shadow mb-6">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            ...
                            <textarea rows="2"
                                disabled
                                class="justify-items-start uppercase w-full p-1 border-b text-[12px] border-gray-300 rounded-md focus:outline-none focus:ring-custom-yellow">{{ optional($profiledTaggedApplicant->shelterLivingSituation)->living_situation_description ?? '--' }}
                            </textarea>
                            @endif
                        </div>
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            ...
                            @else
                            @if($profiledTaggedApplicant->shelter_living_situation_id == 8)
                            <textarea rows="2"
                                disabled

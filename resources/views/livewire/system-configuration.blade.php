<div class="app-page">
    <div class="mb-5 flex items-center gap-3 rounded z-0 relative bg-white justify-between p-4 shadow sm:flex-row sm:items-center sm:justify-between">
        <div class="flex-col items-center">
                        <h1 class="font-semibold text-[14px] text-gray-800">System Configuration</h1>

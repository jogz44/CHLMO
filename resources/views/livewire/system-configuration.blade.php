                        ...
                        <div class="mt-2">
                            ...
                            <template x-for="(status, index) in civilStatuses" :key="index">
                                <div class="flex items-center mb-1">
                                    ...
                                    <button @click="confirmRemoveCivilStatus(index); showConfirmModal = true" class="ml-2 text-red-600 hover:text-red-700">&#x2715;</button>
                                </div>
                            </template>
                            ...
                            <div x-show="showConfirmModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                <div class="bg-white rounded-lg p-6 w-[300px]">
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <button wire:click.prevent="removeCivilStatus" class="w-full py-1 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg">Remove</button>
                            ...
                            <div>
                                ...
                                <template x-for="(tribe, index) in applicant_tribes" :key="index">
                                    <div class="flex items-center mb-1">
                                        ...
                                        <button @click="confirmRemoveTribe(index); showConfirmModal = true" class="ml-2 text-red-600 hover:text-red-700">
                                            &#x2715;
                                        </button>
                                    </div>
                                </template>
                                ...
                                <div x-show="showConfirmModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                    <div class="bg-white rounded-lg p-6 w-[300px]">
                                        <h3 class="text-md font-semibold text-black mb-4">Are you sure you want to remove this?</h3>
                                        <div class="grid grid-cols-2 gap-4">
                                            <button wire:click.prevent="removeTribe" class="w-full py-1 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg">Remove</button>
                                            <button @click="showConfirmModal = false" class="w-full py-1 bg-gray-600 hover:bg-gray-500 text-white font-semibold rounded-lg">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div x-show="openModal3" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                            <div class="bg-white rounded-lg p-6 w-[400px] max-h-[80vh] overflow-y-auto">
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-4 mt-8">
                                    <button @click.prevent="$wire.religions = religionss; $wire.addreligion();" class="w-full py-2 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-lg flex items-center justify-center">
                                        <span class="text-[12px]">ADD</span>
                                    </button>
                            ...
                            <div>
                                ...
                                <template x-for="(situation, index) in livingSituations" :key="index">
                                    <div class="flex items-center mb-3 mt-1">
                                        ...
                                        <button @click="confirmRemove(index)" class="ml-2 text-red-600 hover:text-red-700">
                                            &#x2715;
                                        </button>
                                    </div>
                                </template>
                                ...
                                <!-- Add new input button -->
                                <button @click="livingSituations.push('')" class="w-full py-1 bg-gray-100 shadow-md border-collapse hover:bg-green-300 text-gray-700 rounded-md flex items-center justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-600 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                    </svg>
                                ...
                                <div x-show="showConfirmModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                    <div class="bg-white rounded-lg p-6 w-[300px]">
                                        <h3 class="text-md font-semibold text-black mb-4">Are you sure you want to remove this?</h3>
                                        <div class="grid grid-cols-2 gap-4">
                                            <button @click="removelivingSituationts(confirmRemoveIndex) confirmDelete = false;" class="w-full py-1 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg">Remove</button>
                                            <button @click="showConfirmModal = false" class="w-full py-1 bg-gray-600 hover:bg-gray-500 text-white font-semibold rounded-lg">Cancel</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div x-show="openModal5" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                            <div class="bg-white rounded-lg p-6 w-[400px] max-h-[100vh] overflow-y-auto]">
                                ...
                                <div class="mt-3 ">
                                    ...
                                    <!-- Add new input button -->
                                    <button @click="case_specifications.push('')" class="w-full py-1 bg-gray-100 shadow-md border-collapse hover:bg-green-300 text-gray-700 rounded-md flex items-center justify-center mt-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-600 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                                    ...
                                    <div x-show="confirmDelete" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                        <div class="bg-white rounded-lg p-6 w-[300px]">
                                            <h3 class="text-md font-semibold text-black mb-4">Are you sure you want to remove this?</h3>
                                            <div class="grid grid-cols-2 gap-4">
                                                <button @click="removeCaseSpecification(confirmRemoveIndex)" confirmDelete=false;" class="w-full py-1 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg">Remove</button>
                                                <button @click="showConfirmModal = false" class="w-full py-1 bg-gray-600 hover:bg-gray-500 text-white font-semibold rounded-lg">Cancel</button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div x-data="{ openModal6: false, confirmDelete: false, deleteIndex: null, living_statuses: [''] }">
                        ...
                        <div x-show="openModal6" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                            <div class="bg-white rounded-lg p-6 w-[400px] max-h-[80vh] overflow-y-auto">
                                ...
                                @endforeach
                                <div>
                                    <label class="block text-[12px] font-medium mt-2 mb-2 text-black">LIVING STATUS</label>
                                    ...
                                    <!-- Add new input button -->
                                    <button @click="living_statuses.push('')" class="w-full py-1 bg-gray-100 shadow-md border-collapse hover:bg-green-300 text-gray-700 rounded-md flex items-center justify-center mt-3">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-green-600 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                        </svg>
                                    ...
                                    <div x-show="showConfirmModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                        <div class="bg-white rounded-lg p-6 w-[300px]">
                                            <h3 class="text-md font-semibold text-black mb-4">Are you sure you want to remove this?</h3>
                                            <div class="grid grid-cols-2 gap-4">
                                                <button @click="removeLivingStatus(confirmRemoveIndex)" class="w-full py-1 bg-red-600 hover:bg-red-500 text-white font-semibold rounded-lg">Remove</button>
                                                <button @click="showConfirmModal = false" class="w-full py-1 bg-gray-600 hover:bg-gray-500 text-white font-semibold rounded-lg">Cancel</button>
                                            </div>
                                        </div>
                                    </div>

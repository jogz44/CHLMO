    ...
    <div class="flex bg-gray-100 text-[12px]">
        ...
        <div class="app-table-scroll">
            ...
            <div class="bg-white p-6 rounded shadow">
                <div class="flex justify-between items-center">
                    <div class="flex space-x-2">
                        ...
                        <div class="relative hidden md:block border-gray-300">
                            <svg class="absolute top-[9.5px] left-4" width="19" height="19" viewBox="0 0 21 21"
                    ...
                    <div class="flex justify-end hidden lg:flex md:flex">
                ...
                <div x-show="openFilters" class="flex-col lg:flex-row lg:gap-0 gap-2 flex space-x-2 mb-1 mt-5">

        ...
        <div x-data="{ isEditable: false }" class="flex-1 p-6 overflow-auto">
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                <form wire:submit.prevent="saveChanges">
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-1/4 px-2 mb-4">
                            <label for="purok_id" class="block text-[12px] font-medium text-gray-700 mb-1">PUROK</label>
                            @if($isEditing)
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-1/4 px-2 mb-4">
                            <label for="contactNo" class="block text-[12px] font-medium text-gray-700 mb-1">
                                CONTACT NUMBER
                            </label>
                    ...
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <label for="spouse-monthlyincome" class="block text-[12px] font-medium text-gray-700 mb-1">
                                MONTHLY INCOME
                            </label>
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                <form>
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <label for="taggedDate" class="block text-[12px] font-medium text-gray-700 mb-1">
                                TRANSFERED DATE
                            </label>
            ...
            <div class="bg-white p-6 rounded shadow mb-6">
                <form>
                    <div class="flex flex-wrap -mx-2">
                        ...
                        <div class="w-full md:w-2/12 px-2 mb-4">
                            <label for="awardDate" class="block text-[12px] font-medium text-gray-700 mb-1">
                                AWARDED DATE
                            </label>
                        ...
                        <div class="w-full md:w-4/12 px-2 mb-4">
                            <label for="livingSituation" class="block text-[12px] font-medium text-gray-700 mb-1">
                        ...
                        <div class="w-full md:w-4/12 px-2 mb-4">
                            <label for="caseSpecific" class="block text-[12px] font-medium text-gray-700 mb-1">
                                CASE SPECIFICATION
                            </label>
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <label for="govAssistance" class="block text-[12px] font-medium text-gray-700 mb-1">
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <label for="livingStatus" class="block text-[12px] font-medium text-gray-700 mb-1">
                                LIVING STATUS
                            </label>
                    ...
                    <div class="flex flex-wrap -mx-2">
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <label class="block text-[12px] font-medium text-gray-700 mt-1 mb-1">
                                HOUSE MATERIALS
                            </label>
                            <label for="roof" class="block text-[12px] font-medium text-gray-700 mb-1">
                                ROOF
                            </label>
                        ...
                        <div class="w-full md:w-1/3 px-2 mb-4">
                            <label for="wall" class="block text-[12px] font-medium text-gray-700 mt-6 mb-1">
                                WALL
                            </label>
